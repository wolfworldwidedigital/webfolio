              ...
              <ul>
                ...
                <li>
                  <div className="list_inner">
                    ...
                    <span>
                      <a href="mailto:example@gmail.com">admin@wolfworldwide.digital</a>
                    </span>
                  </div>
                </li>
                <li>
                  <div className="list_inner">
                    <i className="icon-github-rect" />
                    <span>
                      <a href="https://github.com/wolfworldwidedigital">github.com/wolfworldwidedigital</a>
                    </span>
                  </div>
                </li>
              </ul>
